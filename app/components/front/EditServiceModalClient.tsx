  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-mainColor-default">Edit Service</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            <Button 
              type="submit"
              className="bg-mainColor-light hover:bg-mainColor-dark text-grey-50"
            >
              Update Service
            </Button>
          </div>
